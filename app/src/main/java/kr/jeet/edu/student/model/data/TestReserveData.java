...
public class TestReserveData implements Parcelable {
    ...
    public static final Creator<TestReserveData> CREATOR = new Creator<TestReserveData>() {
        @Override
        public TestReserveData createFromParcel(Parcel in) {
            return new TestReserveData(in);
        }

        @Override
        public TestReserveData[] newArray(int size) {
            return new TestReserveData[size];
        }
    };
}
