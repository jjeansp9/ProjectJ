...
public class BaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     *      1. 테스트예약 목록[부모앱,관리자앱] : 과목 추가 (관리자,사용자) - o
     *      1-1. 테스트예약 목록[부모앱,관리자앱] : 날짜형식 ios에 맞게 수정 - o
     *      2. 상담요청 상세[관리자앱] : ios랑 ui 맞추기 - o
     *      2-1. 성적표도 상담요청 상세처럼[부모,관리자] - o
     *      3. 시스템알림 출결현황: 목록 item 클릭시 dialog 보여주기 - o
     *      4. 시스템알림 미납: 월 변경시 목록 갱신 이슈 [api 이슈]
     *      5. 시스템알림 목록, 상세: 시간 단위 분까지 - o
     *      6. 출석부: 캘린더, 범례 양 옆 마진주기 - o
     *      7. 목록 갱신시 리스트 최상단으로 스크롤 - o
     *      8. dialog 내용 길어지면 scroll - o
     *      9. 자녀선택 목록 - [캠퍼스 부서명 / 학년] -> [학교명 / 학년] - o
     *      10. 포토뷰 - 가로세로 기능 - o
     *      11. 홈버튼 아이콘 집모양으로 변경 - o
     *      12. timePicker 10분단위로
    * */
