...
public class ReportCardShowType0Adapter extends AbstractReportCardShowAdapter  {
    ...
    public ReportCardShowType0Adapter(Context context, ArrayList<ReportCardShowActivity.ExamListTypeItem> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        LogMgr.e("ReportAdapter", examList.size()+"" );
    ...
    public class ContentViewHolder extends RecyclerView.ViewHolder{
        ...
        public ContentViewHolder(@NonNull View itemView){
            super(itemView);
//            itemView.setBackground(context.getDrawable(R.drawable.bg_card_content));
...
//                itemView.setBackground(context.getDrawable(R.drawable.bg_card_content));
//            }else{
//                itemView.setBackground(context.getDrawable(R.drawable.bg_card_footer));
//            }
