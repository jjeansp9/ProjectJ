package kr.jeet.edu.student.activity.menu.leveltest;
...
public class InformedQuestionActivity extends BaseActivity {
    ...
    private PowerSpinnerView mSpinnerProcess_1, mSpinnerProcess_2, mSpinnerProcess_3;
    private RecyclerView mRecyclerArea, mRecyclerSchool;
